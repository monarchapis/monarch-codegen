				...
				_.each(apiDeclaration.models, function(model, name) {
					...
					_.each(model.properties, function(property, name) {
						...
						if (property.type == "integer") {
							if (property.minimum) converted.minimum = parseInt(property.minimum);
							if (property.maximum) converted.maximum = parseInt(property.maximum);
						} else if (converted.type == "number") {
							if (property.minimum) converted.minimum = parseFloat(property.minimum);
							if (property.maximum) converted.maximum = parseFloat(property.maximum);
						}
