...
function JavaGenerator(specs, config, templateEngine, fileWriter) {
	...
	_.each(
		['model', 'resource', 'resourceImpl', 'resourceAsync', 'resourceAsyncImpl',
		 'queryBuilder', 'apiHome', 'apiHomeImpl',
...
JavaGenerator.prototype.decorateOperation = function(operation, resource, name) {
	var okResponse = operation.responses && (operation.responses["200"] || operation.responses["201"])
		? (operation.responses["200"] || operation.responses["201"]).schema || {} : {};
